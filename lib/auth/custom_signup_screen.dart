              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _loading ? CircularProgressIndicator() : const Text('Sign Up', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  ),
                ),
                const SizedBox(height: 16),
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: const Text('Log in', style: TextStyle(color: Color(0xFFFFC107), fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
              ],
